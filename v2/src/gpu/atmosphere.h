    ...
    bool init(const Falcor::ref<Falcor::Device> &device) {
        ...
        try {
            transPass_ = Falcor::ComputePass::create(
                device_, "v2/shaders/AtmoTransmittance.cs.slang", "main");
            multiPass_ = Falcor::ComputePass::create(
                device_, "v2/shaders/AtmoMultiScatter.cs.slang", "main");
            skyPass_ =
                Falcor::ComputePass::create(device_, "v2/shaders/AtmoSkyView.cs.slang", "main");
