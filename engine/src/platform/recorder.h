...
#include "platform/audiotap.h"  // vb::AudioRing -- the tap the take keeps
...
class Nv12Convert {
  public:
    void init(Falcor::ref<Falcor::Device> device) {
        if (pass_) return;
        device_ = device;
        pass_ = ComputePass::create(device_, "v1/shaders/CaptureNv12.cs.slang", "main");
