  ...
  public:
    ...
    bool init(const Falcor::ref<Falcor::Device> &device) {
        ...
        try {
            ...
            expHistogram_ =
                Falcor::ComputePass::create(device_, "v1/shaders/Exposure.cs.slang", "histogram");
            expResolve_ =
                Falcor::ComputePass::create(device_, "v1/shaders/Exposure.cs.slang", "resolve");
            bloomPre_ =
                Falcor::ComputePass::create(device_, "v1/shaders/Bloom.cs.slang", "prefilter");
            bloomDown_ = Falcor::ComputePass::create(device_, "v1/shaders/Bloom.cs.slang", "down");
            bloomUp_ = Falcor::ComputePass::create(device_, "v1/shaders/Bloom.cs.slang", "up");
