@echo off
REM ---------------------------------------------------------------------------
REM build_physx.bat -- build NVIDIA PhysX 5 for v2, once.
REM
...
REM machine -- v2 builds with 2026 (v18) -- and that generator does not fall
...
REM with whatever cl.exe the environment provides. So v2 ships its own preset --
...
REM and a long list of architectures, and what v2 wants from PhysX is a
...
REM
REM Run once. v2's own build.bat picks up the result if it is there and builds
...
echo.
echo built. v2's build.bat will find PhysX under
echo     %PHYSX%\bin
exit /b 0
