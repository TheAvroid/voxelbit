...
class Ddgi {
  ...
  private:
    std::string status_ = "built without the RTXGI SDK (set V4_RTXGI_DIR)";
};
#else
...
class Ddgi {
  ...
  private:
    ...
    bool createTextures() {
        ...
        texRayData_ = make(T::RayData, desc_.probeRayDataFormat, "v4::ddgiRayData", rw);
        texIrradiance_ =
            make(T::Irradiance, desc_.probeIrradianceFormat, "v4::ddgiIrradiance", rwRt);
        texDistance_ = make(T::Distance, desc_.probeDistanceFormat, "v4::ddgiDistance", rwRt);
        texProbeData_ = make(T::Data, desc_.probeDataFormat, "v4::ddgiProbeData", rw);
        texVariability_ =
            make(T::Variability, desc_.probeVariabilityFormat, "v4::ddgiVariability", rw);
        texVariabilityAvg_ = make(T::VariabilityAverage, desc_.probeVariabilityFormat,
                                  "v4::ddgiVariabilityAvg", rw);
