  ...
  try {
    ...
    const consts = { DEEP_SPAN, BASIN_RAMP, BASIN_BED, BASIN_GAIN, BIRCH_GAPWOB, BIRCH_ELEV, BIRCH_GAPBED, BIRCH_BANKW, BIRCH_BANKY, BIRCH_BANKK, BIRCH_GAPW, PINE_FLOOR, PINE_CREST, PINE_RELIEF, PINE_BOWL, LAKE_T, LAKE_RAMP, LAKE_PULL, LAKE_BED, LAKE_FLOOR, LAKE_SOFT, LAKE_REL, SAND_SPAN, SAND_APRON, SAND_W, SAND_R, SAND_STEP, SAND_BIS, SAND_TRANS, SAND_CUT, CONT_S, CONT_T, CONT_RAMP, CONT_APRON, OCEAN_BED, OCEAN_SHELF, OCEAN_DEEPRAMP, PIECE, PIECE_JIT, PIECE_WARP, PIECE_WS, PIECE_BORDER, PIECE_PINE, PIECE_BIRCH, PIECE_OAK, PIECE_CHERRY, PIECE_DESERT, OAK_ELEV, DESERT_TERRAIN, STRAIT_ON, RIV_P, RIV_LANDMARGIN, RIV_JITTER, WOB_DES1, WOB_DES2, WOB_OAK, WOB_CH, LIFT, WL, HMAX, RIVCELL, RIVINF, RIVNEAR_CAP, BIOP, DESOFF, DESB, DESW, DESC, DESH, DESY, DESREL, DESDUNE, OAKOFF, OAKB, OAKW, OAKY, OAKHILL, OAKFAR, OAKNEAR, OAKWOFF, OAKC, OAKH, OAKWFAR, OAKWNEAR, OAKBANKR, OAKBANKY, OAKBRISE, OAKBEACH, OAKBEACHY, BIRCHOFF, BIRCHB, BIRCHH, BIRCHC, BIRCHWMAX, BIRCHFAR, BIRCHWFAR, BASIN_T, BASIN_ARCT, BASIN_LOW, BASIN_ARCTLIFT, ARCTOFF, ARCTB, ARCTH, ARCTC, ARCTWMAX, ARCTFAR, ARCTWFAR, ARCTIC_SNOW, ARCT_BARE };   // the BIRCH band: oakRoll/oakBank read its mask and reach, and this worker calls both
    const fns = { basinGain, deepen, bedH, ihash, sstep, pwrap, vnoise, fbm, lakeZoneOf, lakeZone, contC, oceanOf, oceanDeepOf, oceanM, biomeAt, pineRaw, pineBase, riverAt, rivEval, gatherRivers, riversNear, riverS, bankEval, bankDist, desWob, desertM, birchM, arcticM, basinT, basinLow, arctH, oakWob, oakM, oakH, oakRoll, oakBank, duneH, rowNoise, makeHRow, makeMossRow, colNoise, makeHCol, makeMossCol };
    let wsrc = '';
