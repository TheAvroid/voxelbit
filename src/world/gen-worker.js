  ...
  try {
    ...
    const fns = { ihash, sstep, pwrap, vnoise, fbm, riverAt, rivEval, gatherRivers, riversNear, riverS, bankEval, bankDist, desWob, desertM, birchM, arcticM, chWob, bioPin, bioWobZ, bioEdge, bioRivS, basinT, basinLow, arctSeaH, arctH, oakWob, oakM, pineH, oakFieldM, birchH, oakH, oakRoll, oakBank, duneH, rowNoise, makeHRow, makeMossRow, colNoise, makeHCol, makeMossCol };
    let wsrc = '';
