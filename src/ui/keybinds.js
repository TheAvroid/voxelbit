  ...
  const DEFBINDS = { forward: 'KeyW', back: 'KeyS', left: 'KeyA', right: 'KeyD', jump: 'Space', sprint: 'ShiftLeft', crouch: 'CapsLock', drop: 'KeyQ', fly: 'KeyF', record: 'KeyR', scaledown: 'BracketLeft', scaleup: 'BracketRight' };   // L AND V ARE BOTH UNBOUND: the water panel L used to open is off screen and v-sync was removed outright. Back-lit foliage is baked in and needs no key.   // crouch on CAPS LOCK (user 2026-08-05), off Alt   // fly on F restored (user 2026-07-22)
  const BINDNAMES = { forward: 'walk forward', back: 'walk back', left: 'strafe left', right: 'strafe right', jump: 'jump / swim up', sprint: 'sprint', crouch: 'crouch / fly down', drop: 'drop item', fly: 'toggle fly', record: 'record screen', scaledown: 'render scale -', scaleup: 'render scale +' };
