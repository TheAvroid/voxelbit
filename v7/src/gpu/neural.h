...
//
// It is not a library v7 links. It is a capability of the compiler, the driver
...
//   identifier simply does not exist. v7 ships its own Slang 2026.13.1 instead,
...
// thing v7 does with cooperative vectors is COMPILE ONE, at startup, and say
...
class Neural {
  public:
    ...
    bool init(const Falcor::ref<Falcor::Device> &device) {
        ...
        //            are wired up in v7's Falcor fork; what remains is asking.
        // ---------------------------------------------------------------
        Falcor::ProgramDesc d;
        d.addShaderLibrary("v7/shaders/NeuralProbe.cs.slang").csEntry("main");
