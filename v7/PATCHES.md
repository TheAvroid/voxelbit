...
`v7/external/` is not committed — it is 678 MB, and 18 directories under
...
Without these changes v7 does not build. Rebuilding the fork from a clean
...
Lets v7 hand slang-gfx a VkInstance/VkPhysicalDevice/VkDevice it already made,
