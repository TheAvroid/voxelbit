...
class Restir {
  public:
    ...
    bool init(const Falcor::ref<Falcor::Device> &device) {
        ...
        try {
            temporalPass_ =
                Falcor::ComputePass::create(device_, "template/shaders/RestirTemporal.cs.slang", "main");
            spatialPass_ =
                Falcor::ComputePass::create(device_, "template/shaders/RestirSpatial.cs.slang", "main");
    ...
    void allocWorld() {
        ...
        worldKeys_->setName("tpl::restirWorldKeys");
        worldLock_->setName("tpl::restirWorldLock");
        worldRes_->setName("tpl::restirWorldRes");
        worldCleared_ = false;
    }
