...
class Ddgi {
  ...
  private:
    std::string status_ = "built without the RTXGI SDK (set TPL_RTXGI_DIR)";
};
#else
...
class Ddgi {
  ...
  private:
    ...
    bool createTextures() {
        ...
        texRayData_ = make(T::RayData, desc_.probeRayDataFormat, "tpl::ddgiRayData", rw);
        texIrradiance_ =
            make(T::Irradiance, desc_.probeIrradianceFormat, "tpl::ddgiIrradiance", rwRt);
        texDistance_ = make(T::Distance, desc_.probeDistanceFormat, "tpl::ddgiDistance", rwRt);
        texProbeData_ = make(T::Data, desc_.probeDataFormat, "tpl::ddgiProbeData", rw);
        texVariability_ =
            make(T::Variability, desc_.probeVariabilityFormat, "tpl::ddgiVariability", rw);
        texVariabilityAvg_ = make(T::VariabilityAverage, desc_.probeVariabilityFormat,
                                  "tpl::ddgiVariabilityAvg", rw);
