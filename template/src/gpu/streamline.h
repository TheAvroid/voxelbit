...
class Streamline {
  public:
    ...
    static bool preInit(const std::filesystem::path &exeDir) {
        ...
        // default because it is chatty; TPL_SL_LOG=1 turns it on and points it at
        // a directory beside the build.
        const char *slLog = std::getenv("TPL_SL_LOG");
