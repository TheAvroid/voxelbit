...
void usage() {
    std::printf(
        "template -- the lighting stack with no geometry, on Falcor (DXR inline RT)\n"
        "\n"
        "  With no --out, template opens a window and you can fly around in it.\n"
